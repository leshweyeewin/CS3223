...
public class QueryMain{
	...
	public static void main(String[] args){
		...
		**/
		...
		RandomOptimizer2 ro = new RandomOptimizer2(sqlquery);
		Operator logicalroot = ro.getOptimizedPlan();
		if(logicalroot==null){
			System.out.println("root is null");
			System.exit(1);
		}
		if(Batch.getPageSize() < logicalroot.getSchema().getTupleSize()) {
			System.out.println("page size is smaller than tuple size");
			System.exit(1);
		}
